...
#define SSD1306_I2C_MASTER_CLK_SRC          I2C1_CLK_SRC
#define SSD1306_I2C_MASTER_CLK_FREQ         CLOCK_GetFreq(I2C1_CLK_SRC)
#define SSD1306_I2C_MASTER_BASEADDR I2C1
#define SSD1306_WAIT_TIME                   10U

#define SSD1306_I2C_MASTER_SLAVE_ADDR_7BIT 0x3C
#define SSD1306_I2C_BAUDRATE               1000000U
#define SSD1306_I2C_DATA_LENGTH            33U
