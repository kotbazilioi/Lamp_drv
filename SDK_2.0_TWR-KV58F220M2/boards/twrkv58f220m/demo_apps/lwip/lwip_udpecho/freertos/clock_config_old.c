...
#define SIM_TRACE_CLK_FRAC_2                              1U  /*!< Trace clock divider fraction: multiplied by 2 */
...
- {id: CLKOUT.outFreq, value: 50 MHz, locked: true, accuracy: '0.001'}
- {id: Core_clock.outFreq, value: 100 MHz}
- {id: ENET1588TSCLK.outFreq, value: 50 MHz, locked: true, accuracy: '0.001'}
- {id: ERCLK32K.outFreq, value: 1 kHz}
- {id: Flash_clock.outFreq, value: 20 MHz}
- {id: FlexBus_clock.outFreq, value: 50 MHz}
- {id: LPO_clock.outFreq, value: 1 kHz}
- {id: MCGFFCLK.outFreq, value: 25 MHz}
...
- {id: TRACECLKIN.outFreq, value: 200 MHz, locked: true, accuracy: '0.001'}
- {id: WDOGCLK.outFreq, value: 4 MHz, locked: true, accuracy: '0.001'}
settings:
...
- {id: SIM.TRACEFRAC.scale, value: '2'}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetTraceClock(SIM_TRACE_CLK_SEL_CORE_SYSTEM_CLK, SIM_TRACE_CLK_DIV_1, SIM_TRACE_CLK_FRAC_2);
